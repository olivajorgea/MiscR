...
12. Para facilitar la correccion y la localizacion de los posibles errores de la programacion de
vuestro codigo en R, completar la siguiente tabla en relacion a las variables creadas durante
la resolucion de esta practica:
delta= valor
det(P1)
steadyStates(mcP1)[1]
det(P6)
